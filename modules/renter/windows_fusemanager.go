...
var (
	alertMSGFuseDisabled = "Fuse functionality is disabled"
	errNoFuseOnWindows   = errors.New("Fuse library is incompatible with Windows")
)
...
func newFuseManager(r *Renter) renterFuseManager {
	r.staticAlerter.RegisterAlert(modules.AlertIDFuseDisabled, alertMSGFuseDisabled, errNoFuseOnWindows.Error(), modules.SeverityWarning)
