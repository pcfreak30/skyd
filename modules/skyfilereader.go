...
// NewSkyfileMultipartReader wraps the given reader and returns
// a SkyfileUploadReader. By reading from this reader until an EOF is reached,
// the SkyfileMetadata will be constructed incrementally every time a new Part
// is read.
//
...
// a TeeReader of the underlying io.Reader that was used to create the
// multipart.Reader.
func newSkyfileMultipartReader(reader *multipart.Reader, fanoutReader *skyfileMultipartReader, sup SkyfileUploadParameters) *skyfileMultipartReader {
