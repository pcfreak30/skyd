...
func (m *Miner) addNewTxns(diff *skymodules.TransactionPoolDiff) {
...
func (m *Miner) deleteReverts(diff *skymodules.TransactionPoolDiff) {
...
func (m *Miner) getNewSplitSets(diff *skymodules.TransactionPoolDiff) []*mapElement {
...
func (m *Miner) ProcessConsensusChange(cc skymodules.ConsensusChange) {
	m.mu.Lock()
	defer m.mu.Unlock()
...
func (m *Miner) ReceiveUpdatedUnconfirmedTransactions(diff *skymodules.TransactionPoolDiff) {
	m.mu.Lock()
	defer m.mu.Unlock()
