...
type mockSubscriber struct {
	txnMap map[skymodules.TransactionSetID][]types.Transaction
...
// skymodules.TransactionPoolSubscriber interface.
func (ms *mockSubscriber) ReceiveUpdatedUnconfirmedTransactions(diff *skymodules.TransactionPoolDiff) {
...
func TestSubscription(t *testing.T) {
	...
	ms := mockSubscriber{
		txnMap: make(map[skymodules.TransactionSetID][]types.Transaction),
	}
