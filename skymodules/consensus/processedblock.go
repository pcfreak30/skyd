...
type processedBlock struct {
	...
	DiffsGenerated            bool
	SiacoinOutputDiffs        []skymodules.SiacoinOutputDiff
	FileContractDiffs         []skymodules.FileContractDiff
	SiafundOutputDiffs        []skymodules.SiafundOutputDiff
	DelayedSiacoinOutputDiffs []skymodules.DelayedSiacoinOutputDiff
	SiafundPoolDiffs          []skymodules.SiafundPoolDiff
