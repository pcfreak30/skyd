...
func TestApplySiacoinInputs(t *testing.T) {
	...
	if pb.SiacoinOutputDiffs[0].Direction != skymodules.DiffRevert {
...
func TestApplySiacoinOutputs(t *testing.T) {
	...
	if pb.SiacoinOutputDiffs[0].Direction != skymodules.DiffApply {
...
func TestApplyFileContracts(t *testing.T) {
	...
	if pb.FileContractDiffs[0].Direction != skymodules.DiffApply {
...
func TestApplyFileContractRevisions(t *testing.T) {
	...
	if pb.FileContractDiffs[2].Direction != skymodules.DiffRevert {
		t.Error("wrong diff direction applied when revising a file contract")
	}
	if pb.FileContractDiffs[3].Direction != skymodules.DiffApply {
		t.Error("wrong diff direction applied when revising a file contract")
	}
...
func TestApplyStorageProofs(t *testing.T) {
	...
	if pb.FileContractDiffs[3].Direction != skymodules.DiffRevert {
		t.Error("wrong diff direction applied when revising a file contract")
	}
	if pb.FileContractDiffs[3].ID != fcid0 {
		t.Error("wrong id used when revising a file contract")
...
func TestApplySiafundInputs(t *testing.T) {
	...
	if pb.SiafundOutputDiffs[0].Direction != skymodules.DiffRevert {
...
func TestApplySiafundOutputs(t *testing.T) {
	...
	if pb.SiafundOutputDiffs[0].Direction != skymodules.DiffApply {
