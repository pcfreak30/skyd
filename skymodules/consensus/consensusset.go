...
type ConsensusSet struct {
	...
	subscribers []skymodules.ConsensusSetSubscriber
...
func consensusSetBlockingStartup(gateway skymodules.Gateway, persistDir string, deps skymodules.Dependencies) (*ConsensusSet, error) {
...
// will be loaded.
func New(gateway skymodules.Gateway, bootstrap bool, persistDir string) (*ConsensusSet, <-chan error) {
	return NewCustomConsensusSet(gateway, bootstrap, persistDir, skymodules.ProdDependencies)
}

// NewCustomConsensusSet returns a new ConsensusSet, containing at least the genesis block. If
// there is an existing block database present in the persist directory, it
// will be loaded.
func NewCustomConsensusSet(gateway skymodules.Gateway, bootstrap bool, persistDir string, deps skymodules.Dependencies) (*ConsensusSet, <-chan error) {
