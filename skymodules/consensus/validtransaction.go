...
func (cs *ConsensusSet) tryTransactionSet(txns []types.Transaction) (skymodules.ConsensusChange, error) {
	...
	cc := skymodules.ConsensusChange{
		ConsensusChangeDiffs: skymodules.ConsensusChangeDiffs{
...
func (cs *ConsensusSet) LockedTryTransactionSet(fn func(func(txns []types.Transaction) (skymodules.ConsensusChange, error)) error) error {
	err := cs.tg.Add()
	if err != nil {
		return err
	}
