...
func NewSkyfileMultipartReader(reader *multipart.Reader, sup SkyfileUploadParameters) SkyfileUploadReader {
	return newSkyfileMultipartReader(reader, sup)
}
...
func NewSkyfileMultipartReaderFromRequest(req *http.Request, sup SkyfileUploadParameters) (SkyfileUploadReader, error) {
	...
	// Create the multipart reader.
	mpr := multipart.NewReader(req.Body, boundary)
	return NewSkyfileMultipartReader(mpr, sup), nil
}
...
func newSkyfileMultipartReader(reader *multipart.Reader, sup SkyfileUploadParameters) *skyfileMultipartReader {
	return &skyfileMultipartReader{
		...
		metadata: SkyfileMetadata{
			...
			DirResMode:         sup.DirResMode,
			DirResNotFound:     sup.DirResNotFound,
			DirResNotFoundCode: sup.DirResNotFoundCode,
