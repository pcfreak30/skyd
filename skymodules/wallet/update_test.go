...
func TestUpdate(t *testing.T) {
	...
	wt, err := createWalletTester("TestUpdate", skymodules.ProdDependencies)
	if err != nil {
		t.Fatal(err)
	}
	...
	// revert the block
	wt.wallet.ProcessConsensusChange(skymodules.ConsensusChange{
	...
	var revertCC skymodules.ConsensusChange
