...
type (
	...
	fingerprintManager struct {
		current     skymodules.File
		currentPath string
		next        skymodules.File
		nextPath    string
...
func (ap *accountsPersister) openAccountsFile(path string) (skymodules.File, error) {
...
// appropriate metadata header and flags
func (ap *accountsPersister) openFingerprintBucket(path string) (skymodules.File, error) {
...
func (ap *accountsPersister) openFileWithMetadata(path string, flags int, metadata persist.FixedMetadata) (skymodules.File, error) {
...
func (ap *accountsPersister) loadAccounts(file skymodules.File, m map[skymodules.AccountID]*account) error {
...
func syncAndClose(file skymodules.File) error {
	return errors.Compose(
		file.Sync(),
		file.Close(),
	)
