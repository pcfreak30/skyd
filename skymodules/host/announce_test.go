...
type announcementFinder struct {
	...
	netAddresses []skymodules.NetAddress
...
func (af *announcementFinder) ProcessConsensusChange(cc skymodules.ConsensusChange) {
...
func newAnnouncementFinder(cs skymodules.ConsensusSet) (*announcementFinder, error) {
	af := &announcementFinder{
		cs: cs,
	}
	err := cs.ConsensusSetSubscribe(af, skymodules.ConsensusChangeBeginning, nil)
	if err != nil {
		return nil, err
	}
	return af, nil
...
func TestHostAnnounceAddress(t *testing.T) {
	...
	// Create an announcement, then use the address finding module to scan the
	// blockchain for the host's address.
	addr := skymodules.NetAddress("foo.com:1234")
...
func TestHostVerifyAnnouncementAddress(t *testing.T) {
	...
	host1 := skymodules.NetAddress("TwoIPv4Loopback.com:1234")
	host2 := skymodules.NetAddress("TwoIPv6Loopback.com:1234")
	host3 := skymodules.NetAddress("DifferentLoopback.com:1234")
	host4 := skymodules.NetAddress("MoreThanTwo.com:1234")
	host5 := skymodules.NetAddress("LessThanOne.com:1234")
	host6 := skymodules.NetAddress("OneValidIP.com:1234")
	host7 := skymodules.NetAddress("TwoValidIP.com:1234")
	host8 := skymodules.NetAddress("TwoIPSameType.com:1234")
