...
type (
	...
	writeAheadLog struct {
		...
		fileSettingsTmp    skymodules.File
		fileWALTmp         skymodules.File
...
func writeWALMetadata(f skymodules.File) error {
...
func (wal *writeAheadLog) recoverWAL(walFile skymodules.File) error {
