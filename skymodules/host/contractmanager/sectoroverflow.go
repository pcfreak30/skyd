...
func newOverflowMap(path string, deps skymodules.Dependencies) (_ *overflowMap, err error) {
...
// disk.
func initOverflowFile(f skymodules.File) (int64, map[sectorID]overflowEntry, error) {
...
func loadOverflowMap(f skymodules.File) (map[sectorID]overflowEntry, error) {
