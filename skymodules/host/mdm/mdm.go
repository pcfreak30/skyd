...
type Host interface {
	...
	RegistryUpdate(rv skymodules.SignedRegistryValue, pubKey types.SiaPublicKey, expiry types.BlockHeight) (skymodules.SignedRegistryValue, error)
	RegistryGet(pubKey types.SiaPublicKey, tweak crypto.Hash) (skymodules.SignedRegistryValue, bool)
}
