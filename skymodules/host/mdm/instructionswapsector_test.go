...
func testInstructionSwapSectorBasic(t *testing.T, mdm *MDM, numSectors uint64, pt *skymodules.RPCPriceTable, duration types.BlockHeight, so *TestStorageObligation) {
...
func testInstructionSwapSectorSameIndex(t *testing.T, mdm *MDM, numSectors uint64, pt *skymodules.RPCPriceTable, duration types.BlockHeight, so *TestStorageObligation) {
...
func testInstructionSwapSectorOutOfBounds(t *testing.T, mdm *MDM, numSectors uint64, pt *skymodules.RPCPriceTable, duration types.BlockHeight, so *TestStorageObligation) {
...
// testInstructionSwapSectorBasic tests swapping 2 random sectors of a
// filecontract which are not the same.
func testInstructionSwapSectorNoProof(t *testing.T, mdm *MDM, numSectors uint64, pt *skymodules.RPCPriceTable, duration types.BlockHeight, so *TestStorageObligation) {
	// Choose 2 random sectors to swap.
	i := fastrand.Uint64n(numSectors)
	j := fastrand.Uint64n(numSectors)
	for i == j {
