...
func newTestProgramBuilder(pt *skymodules.RPCPriceTable, duration types.BlockHeight) *testProgramBuilder {
	return &testProgramBuilder{
		readonly: true,
		staticPT: pt,

		staticPB:     skymodules.NewProgramBuilder(pt, duration),
...
// complete programs.
func assertCosts(finalized bool, values TestValues, pb *skymodules.ProgramBuilder) {
...
func (tb *testProgramBuilder) AddUpdateRegistryInstruction(spk types.SiaPublicKey, rv skymodules.SignedRegistryValue) {
...
func (tb *testProgramBuilder) Program() (skymodules.Program, skymodules.ProgramData) {
