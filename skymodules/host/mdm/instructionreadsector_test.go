...
func TestInstructionReadSector(t *testing.T) {
	...
	offset := skymodules.SectorSize / 2 // start in the middle
	// Read up to half a sector.
	numSegments := fastrand.Uint64n(skymodules.SectorSize/2/crypto.SegmentSize) + 1
