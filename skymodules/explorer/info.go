...
// given height.
func (e *Explorer) BlockFacts(height types.BlockHeight) (skymodules.BlockFacts, bool) {
	var bf blockFacts
	err := e.db.View(e.dbGetBlockFacts(height, &bf))
	if err != nil {
		return skymodules.BlockFacts{}, false
	}
...
func (e *Explorer) LatestBlockFacts() skymodules.BlockFacts {
	var bf blockFacts
