...
var (
	...
	alignmentScaling = build.Select(build.Var{
		Dev:      uint64(1 << (alignmentScalingStandard - (modules.SectorSizeScalingStandard - modules.SectorSizeScalingDev))),
		Standard: uint64(1 << alignmentScalingStandard), // 1 KiB
		Testing:  uint64(1 << (alignmentScalingStandard - (modules.SectorSizeScalingStandard - modules.SectorSizeScalingTesting))),
	}).(uint64)
