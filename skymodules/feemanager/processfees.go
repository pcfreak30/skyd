...
func (fm *FeeManager) createAndPersistTransaction(feeUIDs []skymodules.FeeUID, outputs []types.SiacoinOutput) (err error) {
...
func (fm *FeeManager) managedProcessFees(feeUIDs []skymodules.FeeUID) error {
...
func (fm *FeeManager) threadedProcessFees() {
	...
	for {
		...
		var feesToProcess, feesToUpdate []skymodules.FeeUID
		fm.mu.Lock()
