...
func testBaseSectorEncryptionWithType(t *testing.T, r *Renter, skykeyType skykey.SkykeyType) {
	...
	fanoutKey2, err := fsKey1.DeriveSubkey(skymodules.FanoutNonceDerivation[:])
	if err != nil {
		t.Fatal(err)
	}
...
func TestBaseSectorKeyID(t *testing.T) {
	...
	var encLayout skymodules.SkyfileLayout
	...
	var encLayout2 skymodules.SkyfileLayout
