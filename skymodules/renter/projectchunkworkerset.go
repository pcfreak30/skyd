...
type chunkFetcher interface {
	Download(ctx context.Context, pricePerMS types.Currency, offset, length uint64, skipRecovery bool) (chan *downloadResponse, error)
}

// Download will download a range from a chunk.
func (pcws *projectChunkWorkerSet) Download(ctx context.Context, pricePerMS types.Currency, offset, length uint64, skipRecovery bool) (chan *downloadResponse, error) {
	return pcws.managedDownload(ctx, pricePerMS, offset, length, skipRecovery)
}
...
func (pcws *projectChunkWorkerSet) managedDownload(ctx context.Context, pricePerMS types.Currency, offset, length uint64, skipRecovery bool) (chan *downloadResponse, error) {
