...
func (bs *bubbleScheduler) callQueueBubble(siaPath skymodules.SiaPath) chan struct{} {
	bs.mu.Lock()
	defer bs.mu.Unlock()
...
func (bs *bubbleScheduler) callThreadedProcessBubbleUpdates() {
	...
	bubbleWorker := func(siaPathChan chan skymodules.SiaPath) {
	...
	for {
		...
		bubbleChan := make(chan skymodules.SiaPath, numBubbleWorkerThreads)
...
func (bs *bubbleScheduler) managedCompleteBubbleUpdate(siaPath skymodules.SiaPath) {
	bs.mu.Lock()
	defer bs.mu.Unlock()
...
func (bs *bubbleScheduler) managedPerformBubbleUpdate(siaPath skymodules.SiaPath) (err error) {
...
func (bs *bubbleScheduler) managedQueueParent(siaPath skymodules.SiaPath) error {
...
func (r *Renter) BubbleMetadata(siaPath skymodules.SiaPath, force, recursive bool) error {
