...
type (
	...
	download struct {
		...
		staticSiaPath         skymodules.SiaPath    // The path of the siafile at the time the download started.
		staticUID             skymodules.DownloadID // unique identifier for the download
...
func (d *download) managedCancel() {
	d.managedFail(skymodules.ErrDownloadCancelled)
}
...
func (d *download) UID() skymodules.DownloadID {
	return d.staticUID
}
...
// returned method.
func (r *Renter) Download(p skymodules.RenterDownloadParameters) (skymodules.DownloadID, func() error, error) {
...
func (r *Renter) DownloadAsync(p skymodules.RenterDownloadParameters, f func(error) error) (id skymodules.DownloadID, start func() error, cancel func(), err error) {
	if err := r.tg.Add(); err != nil {
		return "", nil, nil, err
	}
	defer r.tg.Done()
...
func (r *Renter) managedDownload(p skymodules.RenterDownloadParameters) (_ *download, err error) {
...
func (r *Renter) managedNewDownload(params downloadParams) (*download, error) {
	...
	d := &download{
		...
		staticUID:             skymodules.DownloadID(hex.EncodeToString(fastrand.Bytes(16))),
...
func (r *Renter) DownloadByUID(uid skymodules.DownloadID) (skymodules.DownloadInfo, bool) {
	...
	d.mu.Lock()
	defer d.mu.Unlock()
	return skymodules.DownloadInfo{
