...
func bytesToRecover(chunkFetchOffset, chunkFetchLength, chunkSize uint64, rs skymodules.ErasureCoder) uint64 {
...
func recoveredDataOffset(chunkFetchOffset uint64, rs skymodules.ErasureCoder) uint64 {
	// If partialDecoding is not available we downloaded the whole sector and
