...
func (r *Renter) DeleteFile(siaPath skymodules.SiaPath) error {
	err := r.tg.Add()
	if err != nil {
		return err
	}
...
func (r *Renter) FileList(siaPath skymodules.SiaPath, recursive, cached bool, flf skymodules.FileListFunc) error {
...
func (r *Renter) File(siaPath skymodules.SiaPath) (skymodules.FileInfo, error) {
	if err := r.tg.Add(); err != nil {
...
func (r *Renter) FileCached(siaPath skymodules.SiaPath) (skymodules.FileInfo, error) {
	if err := r.tg.Add(); err != nil {
		return skymodules.FileInfo{}, err
	}
	defer r.tg.Done()
...
func (r *Renter) RenameFile(currentName, newName skymodules.SiaPath) error {
	if err := r.tg.Add(); err != nil {
		return err
	}
	defer r.tg.Done()
...
func (r *Renter) SetFileStuck(siaPath skymodules.SiaPath, stuck bool) (err error) {
	if err := r.tg.Add(); err != nil {
		return err
	}
	defer r.tg.Done()
