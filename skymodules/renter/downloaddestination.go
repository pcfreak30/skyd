...
type downloadDestination interface {
	...
	WritePieces(ec skymodules.ErasureCoder, pieces [][]byte, dataOffset uint64, writeOffset int64, length uint64) error
}
...
func (dw *downloadDestinationBuffer) WritePieces(_ skymodules.ErasureCoder, pieces [][]byte, _ uint64, _ int64, _ uint64) error {
	dw.pieces = pieces
	return nil
}
...
func (ddf *downloadDestinationFile) WritePieces(ec skymodules.ErasureCoder, pieces [][]byte, dataOffset uint64, offset int64, length uint64) error {
...
func (ddw *downloadDestinationWriter) WritePieces(ec skymodules.ErasureCoder, pieces [][]byte, dataOffset uint64, offset int64, length uint64) error {
	write := func() error {
