...
func (c *Contractor) load() error {
	...
	if !reflect.DeepEqual(data.Allowance, skymodules.Allowance{}) {
		...
		if data.Allowance.ExpectedStorage == 0 && data.Allowance.ExpectedUpload == 0 &&
			...
			data.Allowance.ExpectedStorage = skymodules.DefaultAllowance.ExpectedStorage
			data.Allowance.ExpectedUpload = skymodules.DefaultAllowance.ExpectedUpload
			data.Allowance.ExpectedDownload = skymodules.DefaultAllowance.ExpectedDownload
			data.Allowance.ExpectedRedundancy = skymodules.DefaultAllowance.ExpectedRedundancy
			data.Allowance.MaxPeriodChurn = skymodules.DefaultAllowance.MaxPeriodChurn
		}
