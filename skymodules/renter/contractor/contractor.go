...
func (emptyWorkerPool) Worker(_ types.SiaPublicKey) (skymodules.Worker, error) {
...
func (c *Contractor) Allowance() skymodules.Allowance {
	c.mu.RLock()
	defer c.mu.RUnlock()
	return c.allowance
}
...
// billing period.
func (c *Contractor) PeriodSpending() (skymodules.ContractorSpending, error) {
...
func (c *Contractor) callInitRecoveryScan(scanStart modules.ConsensusChangeID) (err error) {
	...
	rs := skymodules.DeriveRenterSeed(s)
