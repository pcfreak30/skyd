...
func TestIntegrationSetAllowance(t *testing.T) {
	...
	a.ExpectedRedundancy = skymodules.DefaultAllowance.ExpectedRedundancy
	a.MaxPeriodChurn = skymodules.DefaultAllowance.MaxPeriodChurn
...
func TestHostMaxDuration(t *testing.T) {
	...
	a := skymodules.Allowance{
		...
		ExpectedUpload:     skymodules.DefaultAllowance.ExpectedUpload,
		ExpectedDownload:   skymodules.DefaultAllowance.ExpectedDownload,
...
func TestPayment(t *testing.T) {
	...
	var contract skymodules.RenterContract
