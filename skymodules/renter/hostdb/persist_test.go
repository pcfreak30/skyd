...
func TestSaveLoad(t *testing.T) {
	...
	var host1, host2, host3 skymodules.HostDBEntry
	host1.FirstSeen = 1
	host2.FirstSeen = 2
	host3.FirstSeen = 3
	...
	filterMode := skymodules.HostDBActiveWhitelist
	...
	hdbt.hdb, errChan = NewCustomHostDB(hdbt.gateway, hdbt.cs, hdbt.tpool, hdbt.mux, filepath.Join(hdbt.persistDir, skymodules.RenterDir), &quitAfterLoadDeps{})
	...
	if hdbt.hdb.filterMode != skymodules.HostDBActiveWhitelist {
