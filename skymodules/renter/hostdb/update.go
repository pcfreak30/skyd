...
func findHostAnnouncements(b types.Block) (announcements []skymodules.HostDBEntry) {
	for _, t := range b.Transactions {
		...
		for _, arb := range t.ArbitraryData {
			...
			var host skymodules.HostDBEntry
...
func (hdb *HostDB) insertBlockchainHost(host skymodules.HostDBEntry) {
