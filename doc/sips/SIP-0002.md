...
1. Extend existing payable RPCs with the `EphermalPayment` option

2. Add notion of an ephemeral account to the hosts

3. Add ability to form a payment channel
