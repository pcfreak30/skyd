...
func TestDeterminePathBasedOnTryFiles(t *testing.T) {
	...
	subfiles := skymodules.SkyfileSubfiles{
		"index.html": skymodules.SkyfileSubfileMetadata{
			Filename: "index.html",
		},
		"404.html": skymodules.SkyfileSubfileMetadata{
			Filename: "404.html",
		},
		"about/index.html": skymodules.SkyfileSubfileMetadata{
			Filename: "about/index.html",
		},
		"news/good-news/index.html": skymodules.SkyfileSubfileMetadata{
			Filename: "news/good-news/index.html",
		},
		"img/image.html": skymodules.SkyfileSubfileMetadata{
	...
	path, diff := determinePathBasedOnTryfiles("anypath", nil, tfWithGlobalIndex)
	if path != "anypath" {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			path, diff = determinePathBasedOnTryfiles(tt.requestPath, subfiles, tt.tryfiles)
