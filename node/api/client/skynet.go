...
func (c *Client) SkynetSkylinkGetWithSCPS(skylink string, scps types.Currency) ([]byte, error) {
...
func (c *Client) SkynetSkylinkGetCustom(skylink string, scps types.Currency, timeout int) ([]byte, error) {
...
func (c *Client) SkynetSkylinkConcatGet(skylink string) (_ []byte, err error) {
	return c.SkynetSkylinkConcatGetWithSCPS(skylink, types.ZeroCurrency)
}
...
func (c *Client) SkynetSkylinkConcatGetWithSCPS(skylink string, scps types.Currency) (_ []byte, err error) {
	values := url.Values{}
